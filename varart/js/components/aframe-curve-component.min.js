!function (e) {
    ...
    var n = new THREE.Vector3(0, 0, 1), r = THREE.Math.degToRad;
    AFRAME.registerComponent("curve-point", {
        ...
        schema: {
            ...
            if (this.points = Array.from(this.el.querySelectorAll("a-curve-point, [curve-point]")), this.points.length <= 1) console.warn("At least 2 curve-points needed to draw a curve"), this.curve = null; else {
            ...
            var a = n + r, s = n - r, o = this.curve.getPointAt(a), c = this.curve.getPointAt(s), u = o.distanceTo(e),
                h = c.distanceTo(e), l = u < h;
            if (r < t) {
    ...
    AFRAME.registerShader("line", {
        schema: {color: {default: "#ff0000"}}, init: function (e) {
            this.material = new THREE.LineBasicMaterial(e)
        }, update: function (e) {
            this.material = new THREE.LineBasicMaterial(e)
        }
    }), AFRAME.registerComponent("draw-curve", {
        schema: {curve: {type: "selector"}}, init: function () {
        ...
        schema: {
            ...
            if (this.remove(), this.data.curve && (this.curve = this.data.curve.components.curve), !this.el.getObject3D("clones") && this.curve && this.curve.curve) {
                var e = this.el.getObject3D("mesh"), t = this.curve.curve.getLength(), i = 0, a = i,
                    s = this.el.getOrCreateObject3D("clones", THREE.Group), o = new THREE.Object3D;
        ...
        mappings: {}
    }), AFRAME.registerPrimitive("a-curve", {defaultComponents: {curve: {}}, mappings: {type: "curve.type"}})
}]);